...
echo Now running https://github.com/lupyuen/nuttx-release/blob/main/run-job-special.sh $1 $2
echo Called by https://github.com/lupyuen/nuttx-release/blob/main/run-ci-special.sh
set -x  ## Echo commands
